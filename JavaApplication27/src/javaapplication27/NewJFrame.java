...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WELCOME STUDENT. PLEASE LOGIN USING YOUR DETAILS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      namme = jTextField1.getText();
       password = jTextField2.getText();
        if (namme.equals("kailen")&& (password.equals("kailen"))) {
            JOptionPane.showMessageDialog(null , "LOGIN SUCESSFUL , WELCOME USER");
             this.setVisible(false);
            program anotherFrame = new program();
                anotherFrame.pack();
